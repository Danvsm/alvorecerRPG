-- Raise the minimum Jokenpo wager to 200 Dracmas while preserving historical rounds.
alter table public.jokenpo_rounds
  drop constraint if exists jokenpo_rounds_bet_cents_check;

alter table public.jokenpo_rounds
  add constraint jokenpo_rounds_bet_cents_check
  check (bet_cents between 20000 and 200000) not valid;

-- Raise Jokenpo rolling 24h winnings cap to 50,000 Dracmas.
