-- Correct Jokenpo maximum wager to 2,000 Dracmas.
...
alter table public.jokenpo_rounds
  ...
  check (bet_cents between 100 and 200000);
...
begin
  ...
  max_bet_cents := least(200000, greatest(100, (source_before / 1000) * 100));
  ...
  return jsonb_build_object(
    ...
    'net_delta_cents', net_delta_cents,
    'balance_after', source_after,
    'max_bet_cents', least(200000, greatest(100, (source_after / 1000) * 100))
  );
end
$$;
