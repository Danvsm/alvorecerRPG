...
comment on function public.send_master_notification(uuid, uuid[], text, text, text)
  is 'Master-only helper to send personalized in-app notifications to active campaign players.';
